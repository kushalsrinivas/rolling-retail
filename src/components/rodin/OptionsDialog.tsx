    ...
    <div className="py-2">
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="advanced" className="space-y-4">
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  className="border-white text-white"
                />
                <Label htmlFor="rodin-gen2" className="text-white">
                  Gen-2 (Latest)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-2">
            <Label className="font-mono text-white">Mesh Mode</Label>
            <RadioGroup
              value={localOptions.mesh_mode}
              onValueChange={(value) => handleChange("mesh_mode", value)}
              className="flex space-x-4"
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  className="border-white text-white"
                />
                <Label htmlFor="rodin-raw" className="text-white">
                  Raw
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  className="border-white text-white"
                />
                <Label htmlFor="rodin-quad" className="text-white">
                  Quad
                </Label>
              </div>
            </RadioGroup>
